...
reservationPrimaryLabel: DEMANA INFORMACIO PER A L'ESCOLA
reservationPrimaryLink: /contact/
whatsappLink: https://wa.me/34608131199?text=Hola%2C%20m%27interessen%20les%20Visites%20Escolars%20Escola%20de%20Bosc.
emailAddress: info@castanyadeviladrau.cat
phoneNumber: +34 608 13 11 99
bookingHighlights:
  - ACTIVITAT ADAPTABLE A EDATS I OBJECTIUS PEDAGOGICS
  - OPCIO DE DINAR ENTRE CASTANYERS
personsMin: 10
personsMax: 30
duration: 2,5 hores
priceFrom: 14EUR
...
languages: Cat - Esp
overviewIntro: Una proposta educativa a l'aire lliure per aprendre des del joc, l'observacio i el contacte directe amb el bosc i els seus oficis.
itinerary:
  - time: 10.00H
    title: Acollida del grup i presentacio de l'espai
    description: Context del dia, normes de seguretat i introduccio al valor del bosc de castanyers.
  - time: 10.20H - 11.20H
    title: Joc de pistes i interpretacio del medi
    description: Activitat dinamica per treballar observacio, orientacio i biodiversitat.
  - time: 11.20H - 12.30H
    title: Taller i tancament
...
includedServices: |
  ...
  - Asseguranca basica i acompanyament durant tota l'activitat.
meetingPoint: |
  La trobada es fa a la finca o al punt acordat per autobusos i centres educatius.

  Compartirem abans de la visita les indicacions logistiques i la previsio horaria.
additionalInfo: |
...
gallery:
  ...
  - image: /assets/images/gallery/visites/visites_guiades_3.jpg
    alt: Espai de taller i tast
---

Les visites escolars volen acostar el bosc a nens i joves des d'una experiencia activa, sensible i arrelada al territori. No es tracta nomes d'explicar continguts, sino de viure'ls en primera persona.

Treballam amb grups que busquen una sortida amb sentit pedagogic, connexio amb la natura i un espai segur on explorar la relacio entre paisatge, biodiversitat i ofici.

### Objectius de la proposta

- Despertar la curiositat pel medi natural i pel cicle de la castanya.
- Comprendre el paper del bosc i la seva gestio en el territori.
- Fomentar l'observacio, el treball en equip i el respecte per l'entorn.
