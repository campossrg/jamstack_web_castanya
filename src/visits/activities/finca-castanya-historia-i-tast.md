...
whatsappLink: https://wa.me/34608131199?text=Hola%2C%20m%27interessa%20la%20visita%20Finca%20de%20la%20Castanya.
emailAddress: info@castanyadeviladrau.cat
phoneNumber: +34 608 13 11 99
bookingHighlights:
  - EXPERIENCIA TRANQUILLA I A MIDA
...
overviewIntro: Una visita per descobrir la historia del projecte, coneixer el treball artesanal que hi ha darrere de cada producte i acabar amb un tast reposat.
itinerary:
  - time: 11.00H
    title: Benvinguda a la finca
    description: Presentacio del projecte, de l'espai i de la trajectoria de Castanya de Viladrau.
  - time: 11.20H - 11.45H
    title: Recorregut pels espais de treball
    description: Coneixem els processos, els formats de producte i la vinculacio amb el territori.
  - time: 11.45H - 12.00H
    title: Tast artesa
...
includedServices: |
  ...
  - Explicacio del projecte i de la transformacio de la castanya.
meetingPoint: |
  La trobada es fa directament a la finca.

  T'enviarem les indicacions d'accés i recomanacions d'aparcament amb la confirmacio de reserva.
additionalInfo: |
...
gallery:
  ...
  - image: /assets/images/gallery/visites/visites_guiades_1.jpg
    alt: Entorn natural de la finca
  - image: /assets/images/gallery/visites/visites_guiades_2.jpg
    alt: Acces a la finca
---

La finca es el lloc on el relat del bosc pren forma. Aqui expliquem d'on venim, com treballem i quina mirada hi ha darrere de cada decisio vinculada a la castanya de Viladrau.

Es una experiencia pensada per a qui vol entendre el projecte amb calma, posar cara als processos i descobrir com el territori, l'artesania i la gastronomia poden anar de la ma.

### Durant la visita descobriras

- La historia i l'evolucio del projecte.
- Els diferents formats de producte i la seva logica artesanal.
- El vincle entre recuperacio del bosc, transformacio alimentaria i cultura local.
